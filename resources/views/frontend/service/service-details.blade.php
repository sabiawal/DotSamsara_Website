    ...
    <section class=" space-top space-extra-bottom">
        <div class="container">
            <div class="row flex-row-reverse">
                <div class="col-lg-8">
                    <div class="mb-3 pb-3"><img src="frontend/assets/img/service/sr-d-1-1.jpg" alt="Project image"></div>
                    ...
                    <div class="row gx-0 mb-4 pb-2 pt-3   wow fadeInUp" data-wow-delay="0.2s">
                        <div class="col-xl-6"><img src="frontend/assets/img/service/sr-d-1-2.jpg" alt="project image" class="w-100"></div>
                        <div class="col-xl-6">
                    ...
                    <div class="row pt-3 mb-30 pb-10 gy-30   wow fadeInUp" data-wow-delay="0.2s">
                        <div class="col-md-6"><img src="frontend/assets/img/service/sr-d-1-3.jpg" alt="project image"></div>
                        <div class="col-md-6"><img src="frontend/assets/img/service/sr-d-1-4.jpg" alt="project image"></div>
                    </div>
                    <!-- FAQ Area -->
                ...
                <div class="col-lg-4">
                    <aside class="service-sidebar">
                        ...
                        <div class="quote-box" data-bg-src="frontend/assets/img/widget/quote-box.jpg">
