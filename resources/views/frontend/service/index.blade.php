...
<head>
    ...
    <title>TechBiz - IT Solution & Service HTML Template - Services</title>
...
============================== -->
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4">
                    <div class="service-style1 layout2">
                        <div class="service-bg" data-bg-src="frontend/assets/img/bg/sr-box-bg-1.jpg"></div>
                        <div class="service-icon"><img src="frontend/assets/img/icon/sr-icon-1-1.png" alt="Features"></div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="service-style1 layout2">
                        <div class="service-bg" data-bg-src="frontend/assets/img/bg/sr-box-bg-1.jpg"></div>
                        <div class="service-icon"><img src="frontend/assets/img/icon/sr-icon-1-2.png" alt="Features"></div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="service-style1 layout2">
                        <div class="service-bg" data-bg-src="frontend/assets/img/bg/sr-box-bg-1.jpg"></div>
                        <div class="service-icon"><img src="frontend/assets/img/icon/sr-icon-1-3.png" alt="Features"></div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="service-style1 layout2">
                        <div class="service-bg" data-bg-src="frontend/assets/img/bg/sr-box-bg-1.jpg"></div>
                        <div class="service-icon"><img src="frontend/assets/img/icon/sr-icon-1-4.png" alt="Features"></div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="service-style1 layout2">
                        <div class="service-bg" data-bg-src="frontend/assets/img/bg/sr-box-bg-1.jpg"></div>
                        <div class="service-icon"><img src="frontend/assets/img/icon/sr-icon-1-5.png" alt="Features"></div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="service-style1 layout2">
                        <div class="service-bg" data-bg-src="frontend/assets/img/bg/sr-box-bg-1.jpg"></div>
                        <div class="service-icon"><img src="frontend/assets/img/icon/sr-icon-1-6.png" alt="Features"></div>
    ...
    Work Process
    ==============================-->
    <section class="process-wrap1 space-top space-extra-bottom" data-bg-src="frontend/assets/img/bg/process-bg-3-1.jpg">
        <div class="container   wow fadeInUp" data-wow-delay="0.2s">
            ...
            <div class="row justify-content-between">
                <div class="col-md-4 col-xl-auto process-style2">
                    <div class="process-arrow"><img src="frontend/assets/img/icon/process-arrow-2-1.png" alt="arrow"></div>
                    <div class="process-icon">
                        <img src="frontend/assets/img/icon/process-1-1.png" alt="icon">
                ...
                <div class="col-md-4 col-xl-auto process-style2">
                    <div class="process-arrow"><img src="frontend/assets/img/icon/process-arrow-2-1.png" alt="arrow"></div>
                    <div class="process-icon">
                        <img src="frontend/assets/img/icon/process-1-2.png" alt="icon">
                ...
                <div class="col-md-4 col-xl-auto process-style2">
                    <div class="process-arrow"><img src="frontend/assets/img/icon/process-arrow-2-1.png" alt="arrow"></div>
                    <div class="process-icon">
                        <img src="frontend/assets/img/icon/process-1-3.png" alt="icon">
