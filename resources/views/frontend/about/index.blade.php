...
<head>
    ...
    <title>DotSamsara - About Us</title>
...
<body>
  ...
  ==============================-->
    ...
    About Us
    ==============================-->
    <section data-bg-src="frontend/assets/img/bg/about-bg-5-1.jpg">
        <div class="container container-style1">
            <div class="row flex-row-reverse align-items-center gx-70">
                <div class="col-lg-6 col-xl">
                    <img src="frontend/assets/img/about/ab-7-1.jpg" alt="about image">
                </div>
    ...
    Testimonial Area
    ==============================-->
    <section class=" space-top space-extra-bottom" data-bg-src="frontend/assets/img/bg/testi-bg-4-1.jpg">
        <div class="container  wow fadeInUp" data-wow-delay="0.2s">
            ...
            <div class="row testi-style2-slide vs-carousel" data-slide-show="2" data-md-slide-show="2">
                <div class="col-xl-6">
                    <div class="testi-style2">
                        <div class="testi-body">
                            <div class="author-img"><img src="frontend/assets/img/testimonial/auth-4-1.jpg" alt="Testimonial"></div>
                            <div class="media-body">
                ...
                <div class="col-xl-6">
                    <div class="testi-style2">
                        <div class="testi-body">
                            <div class="author-img"><img src="frontend/assets/img/testimonial/auth-4-2.jpg" alt="Testimonial"></div>
                            <div class="media-body">
                ...
                <div class="col-xl-6">
                    <div class="testi-style2">
                        <div class="testi-body">
                            <div class="author-img"><img src="frontend/assets/img/testimonial/auth-4-3.jpg" alt="Testimonial"></div>
                            <div class="media-body">
