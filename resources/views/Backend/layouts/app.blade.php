...
<head>
    ...
    <link href="{{ asset('backend/assets/vendor/bootstrap-datepicker/css/bootstrap-datepicker.min.css') }}" rel="stylesheet"
        type="text/css" />

    <!-- Bootstrap Timepicker css -->
    <link href="{{ asset('backend/assets/vendor/bootstrap-timepicker/css/bootstrap-timepicker.min.css') }}" rel="stylesheet"
        type="text/css" />
...
<body>
                                ...
                                <div id="layout-boxed">
                                    <div class="form-check form-switch card-switch mb-1">
                                        ...
                                        <label class="form-check-label" for="layout-mode-boxed">
                                            <img src="backend/assets/images/layouts/boxed.png" alt=""
                                                class="img-fluid">
                                        </label>
                                    </div>
                        ...
                        <div class="col-4">
                            <div class="form-check form-switch card-switch mb-1">
                                ...
                                <label class="form-check-label" for="topbar-color-dark">
                                    <img src="backend/assets/images/layouts/topbar-dark.png" alt=""
                                        class="img-fluid">
                                </label>
                            </div>
                            <h5 class="font-14 text-center text-muted mt-2">Dark</h5>
                            ...
                            <div class="col-4">
                                <div class="form-check form-switch card-switch mb-1">
                                    ...
                                    <label class="form-check-label" for="leftbar-color-light">
                                        <img src="backend/assets/images/layouts/sidebar-light.png" alt=""
                                            class="img-fluid">
                                    </label>
                                </div>
                                <h5 class="font-14 text-center text-muted mt-2">Light</h5>
                            ...
                            <div class="col-4">
                                <div class="form-check form-switch card-switch mb-1">
                                    ...
                                    <label class="form-check-label" for="leftbar-size-compact">
                                        <img src="backend/assets/images/layouts/compact.png" alt=""
                                            class="img-fluid">
                                    </label>
                                </div>
    ...
    <script src="{{ asset('backend/assets/vendor/admin-resources/jquery.vectormap/maps/jquery-jvectormap-world-mill-en.js') }}">
    </script>
